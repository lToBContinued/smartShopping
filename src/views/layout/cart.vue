    ...
    <div v-if="isLogin && cartList.length > 0">
      ...
      <div class="cart-list">
        <div class="cart-item" v-for="item in cartList" :key="item.goods_id">
          <van-checkbox @click="toggleCheck(item.goods_id)" :value="item.isChecked"
                        checked-color="#FA2F21"></van-checkbox>
          <div class="show">
          ...
          <div class="info">
            ...
            <div class="price">¥&nbsp;<span>{{ item.goods.goods_price_min }}</span></div>
              <!--既希望保留原有的传参，又需要通过调用函数传参 => 箭头函数包装一层-->
            <CountBox
      ...
      <div class="footer-fixed">
        ...
        <div class="all-total">
          ...
          <div v-else class="delete" :class="{disabled: selCount === 0}" @click="handelDel">删除</div>
        </div>
      </div>
    </div>
